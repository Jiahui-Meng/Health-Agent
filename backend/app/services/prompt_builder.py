...
def build_system_prompt(locale: str, triage_stage: str) -> str:
    if locale.startswith("zh"):
        ...
        return (
            ...
            "intake 阶段 follow_up_questions 必须是 1-3 条自然、简洁、像医生口头追问的问题，next_steps 必须为空。"
            "disclaimer 不能为空字符串。"
            "如果信息不足，明确提示线下就医评估。"
    ...
    return (
        ...
        "In intake stage, follow_up_questions must contain 1-3 natural focused questions and next_steps must be empty."
